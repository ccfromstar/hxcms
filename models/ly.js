...
exports.get = function() {
	...
	var url = 'http://www.ly.com/youlun/AjaxcallTravel.aspx?Type=GetYoulunPage3&producttypeid=0&hxid=0&hxcid=0&companyid=0&cruiseid=0&harbourid=0&dateid=0&sortManyiType=0&sortPriceType=0&sortCmCountType=0&sortSailDateType=0&dayNum=0&themeId=0&pctabid=&tagNum=0&isTCSpecialLine=0&pageNum=';
	var txtSource = '同程';
	var url_list = [];
	var list = [];
	var max = 780;
